...
namespace firebasesample.iOS.Services.FirebaseAuth
{
    public class FirebaseAuthService : IFirebaseAuthService
    {
        ...
        private void HandleAuthResultLoginHandler(AuthDataResult authResult, NSError error)
        {
            if (error != null)
            {
        ...
        public void SignInWithGoogle()
        {
            XAuth = new OAuth2Authenticator(
                   clientId: "289602937890-fhj9rfrd2mun1p9k4ua4a8oujiisj960.apps.googleusercontent.com",
                    clientSecret: "",
                   scope: "profile",
                   authorizeUrl: new Uri("https://accounts.google.com/o/oauth2/v2/auth"),
                   redirectUrl: new Uri("com.googleusercontent.apps.289602937890-fhj9rfrd2mun1p9k4ua4a8oujiisj960:/oauth2redirect"),
        ...
        private void HandleAuthResultHandlerGoogleSignin(AuthDataResult authResult, NSError error)
        {
            if (error != null)
            {
                AuthErrorCode errorCode;
        ...
        private void HandleAuthResultHandlerSignUp(AuthDataResult authResult, NSError error)
        {
            if (error != null)
            {
                AuthErrorCode errorCode;
